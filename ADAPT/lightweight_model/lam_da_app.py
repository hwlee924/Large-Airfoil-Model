...
class aspire_retriever:
    ...
    def retrieve_context(self, query, angle_threshold, mach_threshold, re_threshold, last_airfoil=None, last_angle=None, last_mach=None):
        ...
        if best_match_idx is not None:
            ...
            if (change_thresholds.lower() == "y"):
                ...
                return self.retrieve_context(query, angle_threshold_new, mach_threshold_new, re_threshold_new, last_airfoil, last_angle, last_mach)
            else:
...
class rag_model:
    ...
    def ask_query(self, web_input, attachment=None):
        ...
        airfoil_angle, airfoil_mach, airfoil_name, retrieved_context = self.retriever.retrieve_context(query, 0.1, 0.01, 100000, self.last_airfoil, self.last_angle, self.last_mach) # get context for RAG
